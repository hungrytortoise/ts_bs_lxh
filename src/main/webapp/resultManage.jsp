...
<div class="add_floor ng_col">
    <div class="table">
        <a href="resultAdd.jsp" class="table-cell table-cell-add">
            <span class="add_issue"><em class="glyphicon glyphicon-plus"></em>提交技术成果</span>
        </a>
    </div>
</div>
            ...
            success:function (data) {
                ...
                for(var i=0;i<data.length;i++) {
                    ...
                    var content = "<div class='col-md-2'>" +
                        ...
                        "<p class='tit he_f2 ellipsis' style='word-wrap: break-word;'>" + title + "</p>" +
